*  QCP written by GAMS Convert at 03/08/17 06:11:48
*
*  Equation counts
*      Total        E        G        L        N        X        C        B
...
e2..  - x10 - x16 - x17 - x18 =E= -13.1;

e3..  - x11 - x19 - x20 - x21 =E= -32.7;

e4..  - x12 - x22 - x23 - x24 =E= -56.5;
...
e12..  - x56 - x74 - x77 - x80 =E= -131;

e13..  - x57 - x75 - x78 - x81 =E= -5109;

e14..  - x58 - x76 - x79 - x82 =E= -3275;

e15..  - x59 - x83 - x86 - x89 =E= -3597;

e16..  - x60 - x84 - x87 - x90 =E= -548706;

e17..  - x61 - x85 - x88 - x91 =E= -13080;

e18..  - x62 - x92 - x95 - x98 =E= -5650;

e19..  - x63 - x93 - x96 - x99 =E= -1412.5;

e20..  - x64 - x94 - x97 - x100 =E= -19775;

e21..  - x74 + 131*x125 =E= 0;

e22..  - x75 + 5109*x125 =E= 0;

e23..  - x76 + 3275*x125 =E= 0;

e24..  - x77 + 131*x126 =E= 0;

e25..  - x78 + 5109*x126 =E= 0;

e26..  - x79 + 3275*x126 =E= 0;

e27..  - x80 + 131*x127 =E= 0;

e28..  - x81 + 5109*x127 =E= 0;

e29..  - x82 + 3275*x127 =E= 0;

e30..  - x83 + 3597*x128 =E= 0;

e31..  - x84 + 548706*x128 =E= 0;

e32..  - x85 + 13080*x128 =E= 0;

e33..  - x86 + 3597*x129 =E= 0;

e34..  - x87 + 548706*x129 =E= 0;

e35..  - x88 + 13080*x129 =E= 0;

e36..  - x89 + 3597*x130 =E= 0;

e37..  - x90 + 548706*x130 =E= 0;

e38..  - x91 + 13080*x130 =E= 0;

e39..  - x92 + 5650*x131 =E= 0;

e40..  - x93 + 1412.5*x131 =E= 0;

e41..  - x94 + 19775*x131 =E= 0;

e42..  - x95 + 5650*x132 =E= 0;

e43..  - x96 + 1412.5*x132 =E= 0;

e44..  - x97 + 19775*x132 =E= 0;

e45..  - x98 + 5650*x133 =E= 0;

e46..  - x99 + 1412.5*x133 =E= 0;

e47..  - x100 + 19775*x133 =E= 0;

e48..  - x56 + 131*x119 =E= 0;

e49..  - x57 + 5109*x119 =E= 0;

e50..  - x58 + 3275*x119 =E= 0;

e51..  - x59 + 3597*x120 =E= 0;

e52..  - x60 + 548706*x120 =E= 0;

e53..  - x61 + 13080*x120 =E= 0;

e54..  - x62 + 5650*x121 =E= 0;

e55..  - x63 + 1412.5*x121 =E= 0;

e56..  - x64 + 19775*x121 =E= 0;

e57..  - x16 + 13.1*x125 =E= 0;

e58..  - x17 + 13.1*x126 =E= 0;

e59..  - x18 + 13.1*x127 =E= 0;

e60..  - x19 + 32.7*x128 =E= 0;

e61..  - x20 + 32.7*x129 =E= 0;

e62..  - x21 + 32.7*x130 =E= 0;

e63..  - x22 + 56.5*x131 =E= 0;

e64..  - x23 + 56.5*x132 =E= 0;

e65..  - x24 + 56.5*x133 =E= 0;

e66..  - x10 + 13.1*x119 =E= 0;

e67..  - x11 + 32.7*x120 =E= 0;

e68..  - x12 + 56.5*x121 =E= 0;
...
e72..  - 110*x26 + x29 + x38 + x47 + x74 + x83 + x92 =L= 0;

e73..  - 16780*x26 + x30 + x39 + x48 + x75 + x84 + x93 =L= 0;

e74..  - 400*x26 + x31 + x40 + x49 + x76 + x85 + x94 =L= 0;

e75..  - 110*x27 + x32 + x41 + x50 + x77 + x86 + x95 =L= 0;

e76..  - 16780*x27 + x33 + x42 + x51 + x78 + x87 + x96 =L= 0;

e77..  - 400*x27 + x34 + x43 + x52 + x79 + x88 + x97 =L= 0;

e78..  - 110*x28 + x35 + x44 + x53 + x80 + x89 + x98 =L= 0;

e79..  - 16780*x28 + x36 + x45 + x54 + x81 + x90 + x99 =L= 0;

e80..  - 400*x28 + x37 + x46 + x55 + x82 + x91 + x100 =L= 0;

e81..    x29 + x38 + x47 + x74 + x83 + x92 - x101 =E= 0;

e82..    0.001*x30 + 0.001*x39 + 0.001*x48 + 0.001*x75 + 0.001*x84 + 0.001*x93
       - x102 =E= 0;

e83..    x31 + x40 + x49 + x76 + x85 + x94 - x103 =E= 0;

e84..    0.3*x32 + 0.3*x41 + 0.3*x50 + 0.3*x77 + 0.3*x86 + 0.3*x95 - x104 =E= 0;

e85..    0.1*x33 + 0.1*x42 + 0.1*x51 + 0.1*x78 + 0.1*x87 + 0.1*x96 - x105 =E= 0;

e86..    0.02*x34 + 0.02*x43 + 0.02*x52 + 0.02*x79 + 0.02*x88 + 0.02*x97 - x106
       =E= 0;

e87..    0.3*x35 + 0.3*x44 + 0.3*x53 + 0.3*x80 + 0.3*x89 + 0.3*x98 - x107 =E= 0;

e88..    x36 + x45 + x54 + x81 + x90 + x99 - x108 =E= 0;

e89..    0.5*x37 + 0.5*x46 + 0.5*x55 + 0.5*x82 + 0.5*x91 + 0.5*x100 - x109
       =E= 0;
...
e150..  - 20*x25 + x56 + x59 + x62 + x65 + x68 + x71 =L= 0;

e151..  - 5*x25 + x57 + x60 + x63 + x66 + x69 + x72 =L= 0;

e152..  - 100*x25 + x58 + x61 + x64 + x67 + x70 + x73 =L= 0;
