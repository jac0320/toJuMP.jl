*  QCP written by GAMS Convert at 03/08/17 06:13:05
*
*  Equation counts
*      Total        E        G        L        N        X        C        B
...
e2..  - x10 - x16 - x17 - x18 =E= -20;

e3..  - x11 - x19 - x20 - x21 =E= -15;

e4..  - x12 - x22 - x23 - x24 =E= -5;
...
e12..  - x56 - x74 - x77 - x80 =E= -12000;

e13..  - x57 - x75 - x78 - x81 =E= -10000;

e14..  - x58 - x76 - x79 - x82 =E= -10000;

e15..  - x59 - x83 - x86 - x89 =E= -6000;

e16..  - x60 - x84 - x87 - x90 =E= -3000;

e17..  - x61 - x85 - x88 - x91 =E= -1500;

e18..  - x62 - x92 - x95 - x98 =E= -1000;

e19..  - x63 - x93 - x96 - x99 =E= -5000;

e20..  - x64 - x94 - x97 - x100 =E= -1000;

e21..  - x74 + 12000*x125 =E= 0;

e22..  - x75 + 10000*x125 =E= 0;

e23..  - x76 + 10000*x125 =E= 0;

e24..  - x77 + 12000*x126 =E= 0;

e25..  - x78 + 10000*x126 =E= 0;

e26..  - x79 + 10000*x126 =E= 0;

e27..  - x80 + 12000*x127 =E= 0;

e28..  - x81 + 10000*x127 =E= 0;

e29..  - x82 + 10000*x127 =E= 0;

e30..  - x83 + 6000*x128 =E= 0;

e31..  - x84 + 3000*x128 =E= 0;

e32..  - x85 + 1500*x128 =E= 0;

e33..  - x86 + 6000*x129 =E= 0;

e34..  - x87 + 3000*x129 =E= 0;

e35..  - x88 + 1500*x129 =E= 0;

e36..  - x89 + 6000*x130 =E= 0;

e37..  - x90 + 3000*x130 =E= 0;

e38..  - x91 + 1500*x130 =E= 0;

e39..  - x92 + 1000*x131 =E= 0;

e40..  - x93 + 5000*x131 =E= 0;

e41..  - x94 + 1000*x131 =E= 0;

e42..  - x95 + 1000*x132 =E= 0;

e43..  - x96 + 5000*x132 =E= 0;

e44..  - x97 + 1000*x132 =E= 0;

e45..  - x98 + 1000*x133 =E= 0;

e46..  - x99 + 5000*x133 =E= 0;

e47..  - x100 + 1000*x133 =E= 0;

e48..  - x56 + 12000*x119 =E= 0;

e49..  - x57 + 10000*x119 =E= 0;

e50..  - x58 + 10000*x119 =E= 0;

e51..  - x59 + 6000*x120 =E= 0;

e52..  - x60 + 3000*x120 =E= 0;

e53..  - x61 + 1500*x120 =E= 0;

e54..  - x62 + 1000*x121 =E= 0;

e55..  - x63 + 5000*x121 =E= 0;

e56..  - x64 + 1000*x121 =E= 0;
...
e72..  - 600*x26 + x29 + x38 + x47 + x74 + x83 + x92 =L= 0;

e73..  - 1000*x26 + x30 + x39 + x48 + x75 + x84 + x93 =L= 0;

e74..  - 1000*x26 + x31 + x40 + x49 + x76 + x85 + x94 =L= 0;

e75..  - 600*x27 + x32 + x41 + x50 + x77 + x86 + x95 =L= 0;

e76..  - 1000*x27 + x33 + x42 + x51 + x78 + x87 + x96 =L= 0;

e77..  - 1000*x27 + x34 + x43 + x52 + x79 + x88 + x97 =L= 0;

e78..  - 600*x28 + x35 + x44 + x53 + x80 + x89 + x98 =L= 0;

e79..  - 1000*x28 + x36 + x45 + x54 + x81 + x90 + x99 =L= 0;

e80..  - 1000*x28 + x37 + x46 + x55 + x82 + x91 + x100 =L= 0;
...
e84..    x32 + x41 + x50 + x77 + x86 + x95 - x104 =E= 0;

e85..    0.01*x33 + 0.01*x42 + 0.01*x51 + 0.01*x78 + 0.01*x87 + 0.01*x96 - x105
       =E= 0;

e86..    x34 + x43 + x52 + x79 + x88 + x97 - x106 =E= 0;

e87..    x35 + x44 + x53 + x80 + x89 + x98 - x107 =E= 0;

e88..    x36 + x45 + x54 + x81 + x90 + x99 - x108 =E= 0;

e89..    0.2*x37 + 0.2*x46 + 0.2*x55 + 0.2*x82 + 0.2*x91 + 0.2*x100 - x109
       =E= 0;
...
e150..  - 100*x25 + x56 + x59 + x62 + x65 + x68 + x71 =L= 0;

e151..  - 100*x25 + x57 + x60 + x63 + x66 + x69 + x72 =L= 0;
